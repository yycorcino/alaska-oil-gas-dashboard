const StatDisplay = ({ heading, description, value }: { heading: string; description?: string; value: string }) => {
  return (
    <div className="flex flex-col h-full w-full max-w-xs mx-auto bg-white shadow-lg rounded-lg p-4">
      <div className="flex flex-col mb-4">
        ...
        {description && <h3 className="text-sm text-gray-600 mt-1">{description}</h3>}
      </div>
